  ...
  return (
    <div className="shadow-md m-1">
      <div className="flex mb-4 items-center p-2">
        ...
        {props.data.status === "pending" ? <button className="flex-no-shrink h-8 px-4 mr-1 text-sm transition-colors duration-150 rounded-lg hover:text-white text-green-600 border-green-600 hover:bg-green-600">Done</button> : null}
